...
public class GenericDaoBeanDefinitionParser extends
	...
	protected AbstractBeanDefinition parseInternal(Element element,
		...
		if(beanDefinition.getBeanClassName() != null){
			...
			if(! IBaseDao.class.isAssignableFrom(beanDefinition.getBeanClass()))
			...
			for (Method method : methods) {
				...
				try {
					...
					if (IBaseDao.class.isAssignableFrom(iClazz)) {
		...
		logger.debug("proxyInterfaces:"+interfaces.toString());
