package org.hbhk.aili.boot.server;
...
public class JavaParams {  
    ...
    public static void main(String[] args1) throws Exception {  
        // 匹配静态方法  
        String[] paramNames = getMethodParamNames(JavaParams.class, "main", String[].class);  
        System.out.println(Arrays.toString(paramNames));  
        // 匹配实例方法  
        paramNames = getMethodParamNames(JavaParams.class, "foo", String.class);  
        System.out.println(Arrays.toString(paramNames));  
        // 自由匹配任一个重名方法  
        paramNames = getMethodParamNames(JavaParams.class, "getMethodParamNames");  
        System.out.println(Arrays.toString(paramNames));  
        // 匹配特定签名的方法  
        paramNames = getMethodParamNames(JavaParams.class, "getMethodParamNames", Class.class, String.class);  
        System.out.println(Arrays.toString(paramNames));  
    }  
