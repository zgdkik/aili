...
mini_debugger = true;   
//jquery
document.write('<script src="' + jsPATH + 'jquery/jquery-1.11.0.min.js" type="text/javascript"></script>');
//bootstrap
...
document.write('<script src="' + jsPATH + 'jqgrid/i18n/grid.locale-cn.js" type="text/javascript"></script>');
