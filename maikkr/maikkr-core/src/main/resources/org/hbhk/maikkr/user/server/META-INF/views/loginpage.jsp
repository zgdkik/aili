...
<body>
	<div id="base" class="">
			...
			<div id="u22" class="text">
				<p>
					<span style="text-decoration: underline;"><a
						href="${base}user/register.htm">我要注册</a></span>
				</p>
			</div>
		</div>
		<!-- Unnamed (Shape) -->
		<div id="u23" class="ax_shape">
			<img id="u23_img" class="img " src="${images}/login/u23.png" />
			<!-- Unnamed () -->
		...
		<div id="u27" class="ax_shape">
			<img id="u27_img" class="img " src="${images}/login/u27.png" />
			<!-- Unnamed () -->
		...
		<div id="u33" class="ax_image">
			<img id="u33_img" class="img "
				src="/images/user/home__nologin_/u322.jpg" />
			<!-- Unnamed () -->
		...
		<div id="u37" class="ax_horizontal_line">
			<img id="u37_start" class="img " src="${images}/transparent.gif"
				alt="u37_start" /> <img id="u37_end" class="img "
				src="${images}/transparent.gif" alt="u37_end" /> <img id="u37_line"
				class="img " src="${images}/login/u37_line.png" alt="u37_line" />
		</div>

		<!-- Unnamed (Shape) -->
		<div id="u38" class="ax_shape">
			<img id="u38_img" class="img " src="${images}/reg/u47.png" />
			<!-- Unnamed () -->
			<div id="u39" class="text">
				<p>
					<span>欢迎</span><span>登录</span>
				</p>
			</div>
		</div>
		...
		<div id="u40" class="ax_shape">
			<img id="u40_img" class="img " src="${images}/reg/u49.png" />
			<!-- Unnamed () -->
		...
		<div id="u42" class="ax_menu">
			<img id="u42_menu" class="img "
				src="${images}/home__nologin_/u22_menu.png" alt="u42_menu" />
