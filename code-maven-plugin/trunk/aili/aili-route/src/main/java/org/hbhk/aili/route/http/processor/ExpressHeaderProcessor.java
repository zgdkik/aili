...
import org.hbhk.aili.route.common.exception.AgentEsbHeaderException;
import org.hbhk.aili.route.common.exception.AgentExceptionConstant;
import org.hbhk.aili.route.http.util.URLResolution;
...
import org.hbhk.aili.route.jms.server.security.exception.AuthorizeException;
import org.hbhk.aili.route.jms.server.security.exception.FlowControlException;
...
public class ExpressHeaderProcessor {
	private static Logger LOG = LoggerFactory.getLogger(ExpressHeaderProcessor.class);
	// 服务配置
