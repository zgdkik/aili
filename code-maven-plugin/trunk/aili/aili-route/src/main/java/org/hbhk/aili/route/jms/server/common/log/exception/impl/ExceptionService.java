package org.hbhk.aili.route.jms.server.common.log.exception.impl;
...
import org.hbhk.aili.route.jms.server.common.log.exception.IExceptionService;
...
public class ExceptionService implements IExceptionService {
	 ...
	 * @see org.hbhk.aili.route.jms.server.common.log.exception.IExceptionService#saveException(java.util.Map,
	 *      org.hbhk.aili.route.jms.server.common.CommonExceptionInfo)
	 */
	@Override
