...
//		}
	...
	public static void execute( String projectName ,String moduleName,Class<?> clazz, String author) {
		
		GenerateMain.projectName =projectName;
		GenerateMain.moduleName =moduleName;
		MakeModelService mmService = new MakeModelServiceImpl();
		//Class<?> clazz = Class.forName(args[0]);
		MakeModel mm = mmService.queryByClass(clazz);
