...
public class HessianExporter implements BeanFactoryPostProcessor {
	...
	public void postProcessBeanFactory(
		...
		for (String beanName : beanFactory.getBeanDefinitionNames()) {
			...
			if (!AnnotationUtils.isAnnotationDeclaredLocally(Hessian.class,
					beanType)) {
				continue;
			}

			Hessian remote = AnnotationUtils.findAnnotation(beanType,
					Hessian.class);
	...
	private Class findServiceInterface(Class beanType, Hessian remote) {
