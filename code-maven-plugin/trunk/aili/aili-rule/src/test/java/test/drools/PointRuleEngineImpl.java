...
public class PointRuleEngineImpl implements PointRuleEngine {
	...
	private List<Reader> readRuleFromDrlFile(List<String> drlFilePath)
		...
		for (String ruleFilePath : drlFilePath) {
			String r = FileUtils.readFileToString(new File(ruleFilePath));
			Map<String, Object>  data = new HashMap<String, Object>();
			data.put("rname", "rname");
			data.put("rsalience", 100);
			data.put("rcondition", "true");
			data.put("cc", 8);
			
			//r = FreemarkerUtil.parseStr(r, data);
	...
	private List<String> getTestDrlFile() {
		...
		drlFilePath
				.add("E:/workspace/hbhk00/metertick/metertick-rule/src/test/resources/addpoint.drl");
		drlFilePath
				.add("E:/workspace/hbhk00/metertick/metertick-rule/src/test/resources/subpoint.drl");
