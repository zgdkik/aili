...
(function ($)
{
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            //设置按钮
            g.buttons.btnToday.html(p.todaailiessage);
            ...
            if (p.detailToEdit)
            {
                ...
                p.detail = {
                    ...
                    onShowDetail: function (record, container, callback)
                    {
                        ...
                        $("<div class='l-button'>" + p.applailiessage + "</div>").appendTo(container).click(function ()
                        {
                            g.submitEdit(record);
                        });
