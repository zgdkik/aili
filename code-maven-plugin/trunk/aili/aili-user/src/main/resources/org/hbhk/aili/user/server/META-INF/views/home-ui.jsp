...
<body class="easyui-layout" style="overflow-y: hidden;" scroll="no" >
	...
	<div region="north" class="content" border="false"
		style="overflow: hidden; height: 40px; background: url(images/home/layout-browser-hd-bg1.jpg) #7f99be repeat-x center 50%; line-height: 40px; color: #fff; font-family: Verdana, 微软雅黑, 黑体">
		<span style="margin-left: 10px;display: block;float: left;"><img
			src="${base}/images/home/logo1.png" width="140" height="40"/>
		</span>
		<span style="margin-left: 29px;border-left: 1px solid #fcb814;font-size: 32px;height: 40px;display: block;float: left;">
			<label style="margin-left: 10px; font: 25px fontNameRegular, Arial, sans-serif;color: #FFFFFF">${app_title}</label>
		</span>
	...
	<!-- 底部 -->
	<div region="south" 
		style="height: 30px; background:rgb(0, 180, 0);;">
		<div class="footer" style="color: #fff">Copyright @ 2015 HBHK科技有限公司. All rights reserved.沪ICP备5416号</div>
	</div>
	<!--菜单  -->
	...
	<div id="mainPanle" region="center"
		...
		<div id="tabs" class="easyui-tabs" fit="true" border="false">
			<div title="主页"
				style="padding: 20px; overflow: hidden; color: #000;">
				<h1 style="font-size: 24px;">欢迎使用HBHK平台开发系统</h1>
			</div>
		</div>
	</div>
