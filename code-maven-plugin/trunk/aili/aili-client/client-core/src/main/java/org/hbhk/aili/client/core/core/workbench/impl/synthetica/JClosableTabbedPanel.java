...
public class JClosableTabbedPanel extends JTabbedPane implements MouseListener, MouseMotionListener {
    ...
    public void addTab(String title, Icon icon, Component component) {
    	...
    	overIcon = new CloseOverTabIcon(icon);
    	 super.addTab(title, this.icon, component);
    }
...
class CloseOverTabIcon extends CloseTabIcon {
    public CloseOverTabIcon(Icon fileIcon) {
    	super(fileIcon);
    }
    public void paintIcon(Component c, Graphics g, int x, int y) {
        this.x_pos = x;
