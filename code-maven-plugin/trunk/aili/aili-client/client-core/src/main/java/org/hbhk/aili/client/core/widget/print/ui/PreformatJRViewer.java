...
/**
 ******************************************* 
 * <b style="font-family:微软雅黑"> <small>Description: 客户端套打组件的功能说明： <li>加载表单设计模板
 * <li>表单预览 <li>预览界面放大，缩小 <li>表单套打（只打印数据，不打印背景） <li>表单保存 <li>打印设置 客户端套打组件的设计思路：
 * JasperReports是一个用Java开发的开源的第三方类库， 提供了打印预览控件，不过不适合直接在一个应用中使用，
 * 
 ******************************************** 
 */
public class PreformatJRViewer extends javax.swing.JPanel implements JRHyperlinkListener {
	...
	private JasperPrint preformatJasperPrint;
	 ...
	 * @throws JRException
	 */
	public PreformatJRViewer(String fileName, boolean isXML) throws JRException {
	 ...
	 * @throws JRException
	 */
	public PreformatJRViewer(InputStream is, boolean isXML) throws JRException {
		this(is, isXML, null);
	}
	 ...
	 * @param jrPrint
	 */
	public PreformatJRViewer(JasperPrint jrPrint) {
		this(jrPrint, null);
	}
	 ...
	 * @throws JRException
	 */
	public PreformatJRViewer(String fileName, boolean isXML, Locale locale) throws JRException {
	 ...
	 * @throws JRException
	 */
	public PreformatJRViewer(InputStream is, boolean isXML, Locale locale) throws JRException {
	 ...
	 * @param locale
	 */
	public PreformatJRViewer(JasperPrint jrPrint, Locale locale) {
	 ...
	 * @throws JRException
	 */
	public PreformatJRViewer(String fileName, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException {
	 ...
	 * @throws JRException
	 */
	public PreformatJRViewer(InputStream is, boolean isXML, Locale locale, ResourceBundle resBundle) throws JRException {
		initResources(locale, resBundle);
	 ...
	 * @param resBundle
	 */
	public PreformatJRViewer(JasperPrint jrPrint, Locale locale, ResourceBundle resBundle) {
		initResources(locale, resBundle);
		...
		Thread thread = new Thread(new Runnable() {
			public void run() {
				try {
					...
					JasperPrintManager.printReport(preformatJasperPrint, true);
				} catch (Exception ex) {
					if (log.isErrorEnabled()) {
	...
	public void setPreformatJasperPrint(JasperPrint preformatJasperPrint) {
		this.preformatJasperPrint = preformatJasperPrint;
	}

	public JasperPrint getPreformatJasperPrint() {
		return preformatJasperPrint;
	}
	...
	private void setPageIndex(int index) {
		if (jasperPrint != null && jasperPrint.getPages() != null && jasperPrint.getPages().size() > 0) {
			if (index >= 0 && index < jasperPrint.getPages().size()) {
				...
				lblStatus.setText(MessageFormat.format(getBundleString("page"), new Object[] { Integer.valueOf(pageIndex + 1), Integer.valueOf(jasperPrint.getPages().size()) }));
			}
		} else {
	...
	*/
	...
	protected Image getPageErrorImage() {
		Image image = new BufferedImage((int) (jasperPrint.getPageWidth() * realZoom) + 1, (int) (jasperPrint.getPageHeight() * realZoom) + 1, BufferedImage.TYPE_INT_RGB);
	 ...
	 * 
	 * <p>
	 * Title: setRealZoomRatio
	 * </p>
	 * <p>
	 * Description: 设置区域最佳比例
	 * </p>
	 * 
	 * @param newZoom
	 */
	 ...
	 * 
	 * <p>
	 * Title: setFitWidthZoomRatio
	 * </p>
	 * <p>
	 * Description: 设置区域合适宽度比
	 * </p>
	 */
	 ...
	 * 
	 * <p>
	 * Title: setFitPageZoomRatio
	 * </p>
	 * <p>
	 * Description: 设置页面区域合适比例
	 * </p>
	 */
	...
	static class PageRenderer extends JLabel {
		...
		/*
		 * (non-Javadoc) <p>Title: paintComponent</p> <p>Description: 绘制组件</p>
		 * 
		 * @param g
		 * 
		 ...
		 * 
		 * <p>
		 * Title: setRenderImage
		 * </p>
		 * <p>
		 * Description: 设置是否绘制图片
		 * </p>
		 * 
		 * @param renderImage
		 */
