...
/**
 * <b style="font-family:微软雅黑"><small>Description:网络状态监视器</small></b> </br> <b
 */
public class NetworkMonitor {
	 ...
	 * @Description:内部类，监控器线程，监控网络状态
	 * @date 2011-6-11 上午11:20:07
	 * 
	 */
	...
	URL computeDefaultTestURL(URL url) {
		...
		String[] fixx = urlStr.split("\\/");
		try {
			return new URL(url.getProtocol(), url.getHost(), url.getPort(), "/" + fixx[1].concat("/index.jsp"));
