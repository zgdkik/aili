package org.hbhk.aili.client.core.widget.message;
...
public class RightCornerPopMessage extends JWindow implements Runnable,
	...
	public RightCornerPopMessage(JPanel messagePanel) {

		this.init(messagePanel);
	...
	private void init(JPanel messagePanel) {
