...
public class JClosableTabbedPane extends JTabbedPane implements MouseListener, MouseMotionListener {

	private static final long serialVersionUID = 1L;
	public CloseTabIcon icon;
	public Icon overIcon;
    ...
    public JClosableTabbedPane(int tabPlacement, int tabLayoutPolicy) {
        ...
        overIcon = new CloseOverTabIcon();
        setFocusable(false);
        setUI(new WhiteTabbedPaneUI());
        setBorder(null);
...
//    	this.icon = new CloseTabIcon(icon);
//    	overIcon = new CloseOverTabIcon(icon);
...
//    }
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        Rectangle tabBounds = getUI().getTabBounds(this, tabNumber);
        tabBounds.x = tabBounds.x + tabBounds.width - icon.width - 8;
        tabBounds.y = 6;
        tabBounds.width = icon.width;
        tabBounds.height = icon.height;
        
    	if (tabBounds.contains(e.getX(), e.getY())) {
	...
	public void mouseMoved(MouseEvent e) {
         ...
         if(icon != null){
         	...
         	if (rect.contains(e.getX(), e.getY())) {
         		setIconAt(tabNumber, this.overIcon);
         	}else{
         		setIconAt(tabNumber, this.icon);
         	}
         }
	}
}
...
class CloseOverTabIcon extends CloseTabIcon {
    public CloseOverTabIcon() {
    	super();
    }
    public void paintIcon(Component c, Graphics g, int x, int y) {
        this.x_pos = x;
