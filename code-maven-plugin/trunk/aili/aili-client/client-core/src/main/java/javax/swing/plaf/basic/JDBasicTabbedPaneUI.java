...
public class JDBasicTabbedPaneUI extends TabbedPaneUI implements SwingConstants {
...
// Private instance data
    ...
    private Insets tabBorderInsets = new Insets(0,0,0,0);
...
// UI creation
    ...
    public static ComponentUI createUI(JComponent c) {
        return new JDBasicTabbedPaneUI();
    }
...
// UI Installation/De-installation
    ...
    protected void installDefaults() {
        ...
        tabBorderInsets = UIManager.getInsets("TabbedPane.tabBorderInsets");
...
//        LazyActionMap.installLazyActionMap(tabPane, JDBasicTabbedPaneUI.class,
...
// Tab Navigation methods
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            JDBasicTabbedPaneUI ui = (JDBasicTabbedPaneUI)BasicLookAndFeel.
                       getUIOfType(pane.getUI(), JDBasicTabbedPaneUI.class);
            ...
            if(numChildren > 0) {
                switch(tabPlacement) {
                    ...
                    default:
                        ...
                        // calculate content area bounds
                        cx = contentInsets.left;
                        cy = th + contentInsets.top;
                        cw = bounds.width-
                                contentInsets.left - contentInsets.right;
                        ch = bounds.height - th -
                                contentInsets.top - contentInsets.bottom;
                            ...
                            default:
                                ...
                                if(totalTabWidth > tw) {
                                    ...
                                    bx = (child == tabScroller.scrollForwardButton) ?
                                            bounds.width + insets.left - insets.right - bsize.width :
                                            bounds.width + insets.left - insets.right - 2 * bsize.width;
                                    by = (tabPlacement == TOP ? ty + th - insets.bottom - bsize.height : ty);
                                }
                        }
    ...
    private static class RightAction extends AbstractAction {
		public void actionPerformed(ActionEvent e) {
			JTabbedPane pane = (JTabbedPane) e.getSource();
			JDBasicTabbedPaneUI ui = (JDBasicTabbedPaneUI) pane.getUI();
	...
	private static class SetSelectedIndexAction extends AbstractAction {
		public void actionPerformed(ActionEvent e) {
			...
			if (pane != null && (pane.getUI() instanceof JDBasicTabbedPaneUI)) {
				JDBasicTabbedPaneUI ui = (JDBasicTabbedPaneUI) pane.getUI();
				String command = e.getActionCommand();
    ...
    private class ScrollableTabPanel extends JPanel implements UIResource {
        ...
        public void paintComponent(Graphics g) {
            ...
            JDBasicTabbedPaneUI.this.paintTabArea(g, tabPane.getTabPlacement(),
    ...
    private class Handler implements ChangeListener, ContainerListener,
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (name == "mnemonicAt") {
                ...
                JDBasicTabbedPaneUI.this.uninstallUI(pane);
                JDBasicTabbedPaneUI.this.installUI(pane);
                calculatedBaseline = false;
