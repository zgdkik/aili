...
public class UserJMSException extends BusinessException {
	...
	public UserJMSException(String errCode) {
		super();
		super.errCode = errCode;
	}

	public UserJMSException(String code, String msg) {
		super(code, msg);
	}

	public UserJMSException(String code, String msg, Throwable cause) {
