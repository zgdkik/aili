...
public class SyncOrganizationRequestTrans implements IMessageTransform<SyncAdminOrgRequest> {

	/** The Constant CLZZ. */
	private static final Class<SyncAdminOrgRequest> CLZZ =  SyncAdminOrgRequest.class;

	/** The log. */
	private static Log log = LogFactory.getLog(SyncOrganizationRequestTrans.class);
