...
public class SyncEmployeeRequestTrans implements IMessageTransform<SyncEmployeeRequest> {

	/** The Constant CLZZ. */
	private static final Class<SyncEmployeeRequest> CLZZ =  SyncEmployeeRequest.class;

	/** The log. */
	private static Log log = LogFactory.getLog(SyncEmployeeRequestTrans.class);
