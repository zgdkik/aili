...
public class SyncEmployeeResponseTrans implements IMessageTransform<SendEmployeeResponse> {

	/** The Constant CLZZ. */
	private static final Class<SendEmployeeResponse> CLZZ =  SendEmployeeResponse.class;

	/** The log. */
	private static Log log = LogFactory.getLog(SyncEmployeeResponseTrans.class);
