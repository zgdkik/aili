...
import com.yimidida.ymdp.dao.server.handler.INameHandler;
import com.yimidida.ymdp.dao.share.util.AnnotationScanningUtil;
...
public class AutoCreateTable implements InitializingBean {
	...
	public static void setTableSchema(String tableSchema) {
		AutoCreateTable.tableSchema = tableSchema;
	}
