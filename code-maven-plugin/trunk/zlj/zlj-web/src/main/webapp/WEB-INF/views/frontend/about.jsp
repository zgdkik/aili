...
<head>
    ...
    <title></title>
    <link rel="favicon" href="${base}/assets/images/favicon.png">
    <link rel="stylesheet" media="screen" href="http://fonts.useso.com/css?family=Open+Sans:300,400,700">
    <link rel="stylesheet" href="${base}/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="${base}/assets/css/font-awesome.min.css">
    <!-- Custom styles for our template -->
    <link rel="stylesheet" href="${base}/assets/css/bootstrap-theme.css" media="screen">
...
<body>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">
                    <img src="${base}/assets/images/logo.png" alt="Techro HTML5 template"></a>
            </div>
  ...
  <jsp:include page="../common/common-top.jsp" /> 
    ...
    <section class="container">
        <div class="row">
            ...
            <section class="col-sm-8 maincontent">
                <h3>Our Company</h3>
                <p>
                    <img src="${base}/assets/images/about.jpg" alt="" class="img-rounded pull-right" width="300">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${base}/assets/images/photo-1.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>John Doe</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${base}/assets/images/photo-2.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Larry Doe</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${base}/assets/images/photo-3.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Ranith Kays</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="${base}/assets/images/photo-4.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Joan Ray</h4>
                        <!-- Designation -->
    ...
    <script src="${base}/assets/js/modernizr-latest.js"></script> 
	<script type='text/javascript' src='${base}/assets/js/jquery.min.js'></script>
    <script type='text/javascript' src='${base}/assets/js/fancybox/jquery.fancybox.pack.js'></script>
    
    <script type='text/javascript' src='${base}/assets/js/jquery.mobile.customized.min.js'></script>
    <script type='text/javascript' src='${base}/assets/js/jquery.easing.1.3.js'></script> 
    <script type='text/javascript' src='${base}/assets/js/camera.min.js'></script> 
