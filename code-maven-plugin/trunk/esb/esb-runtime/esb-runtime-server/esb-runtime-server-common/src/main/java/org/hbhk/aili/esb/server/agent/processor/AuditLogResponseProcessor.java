...
import org.hbhk.aili.esb.server.agent.trans.CommonError2CommonExceptionTrans;
...
public class AuditLogResponseProcessor implements Processor{
	...
	public void process(Exchange exchange) throws Exception {
		...
		//TODO
		String resultCode ="1";// (String)exchange.getIn().getHeader(ExpressConstant.EXPRESS_RESUTLCODE);
