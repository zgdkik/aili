...
public class MultiServerProcessor implements Processor {
	...
	public void process(Exchange exchange) throws Exception {
		...
		String esbServiceCode = (String) exchange
				.getProperty(ESBServiceConstant.ESB_SERVICE_CODE);
		...
		String backServiceCod = backServiceCodes.get(index);
		exchange.getIn()
				.getHeaders()
				.put(ESBServiceConstant.BACK_SERVICE_CODE,backServiceCod);
		...
		String endpoint = configLoader.getSvcPointInfo(esbServiceCode).getJmsComponent() + ":"
