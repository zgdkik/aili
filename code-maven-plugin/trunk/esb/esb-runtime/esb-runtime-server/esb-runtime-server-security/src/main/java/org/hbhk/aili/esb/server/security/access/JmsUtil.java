package org.hbhk.aili.esb.server.security.access;
	...
	public  static String getConfig(String configType) {
		...
		try {
			...
			if(1==num){
				...
				UserInterfaceRelation ifc = new UserInterfaceRelation();
				ifc.setActive("Y");
				ifc.setCreateTime(new Date());
				ifc.setFid("hbhk1");
				ifc.setEsbServiceCode("hbhk");
				ifc.setUser("hbhk");
				list.add(ifc);
