 ...
 */
public class ESBIllegalArgumentException extends ESBRunTimeException{

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6251205304926889694L;
	
	/** The code. */
	protected String code = "ESBIllegalArgumentException";
	 ...
	 *            the string
	 */
	public ESBIllegalArgumentException(String string) {
		super(string);
	}
