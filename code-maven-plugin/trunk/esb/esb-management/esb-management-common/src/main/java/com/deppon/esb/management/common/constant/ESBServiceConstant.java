...
public class ESBServiceConstant {
	...
	public static final int REQUEST_ID_MAX_LENGTH = 80;
	public static final int RESPONSE_ID_MAX_LENGTH = 80;
	public static final int BUSINESSID_MAX_LENGTH = 300;
	public static final int BUSINESSDESC1_MAX_LENGTH = 300;
	public static final int BUSINESSDESC2_MAX_LENGTH = 300;
	public static final int BUSINESSDESC3_MAX_LENGTH = 300;
	 ...
	 * Form queueName
	 */
	public static final String FROM_QUEUENAME = "queueName";
}
