...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>scripts/statistic/front/store.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/statistic/front/backView.js"></script>
</body>
</html>
