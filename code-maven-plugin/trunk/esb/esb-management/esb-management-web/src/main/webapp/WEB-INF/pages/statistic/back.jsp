...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>scripts/statistic/back/store.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/statistic/back/backView.js"></script>
</body>
</html>
