...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>scripts/exceptionlog/store.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/exceptionlog/form.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/exceptionlog/grid.js"></script>
