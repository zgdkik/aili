...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>scripts/statistic/exception/store.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/statistic/exception/theme.js"></script>
</body>
</html>
