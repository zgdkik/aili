...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>scripts/exceptionlog2/store.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/exceptionlog2/form.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/exceptionlog2/grid.js"></script>
</body>
</html>