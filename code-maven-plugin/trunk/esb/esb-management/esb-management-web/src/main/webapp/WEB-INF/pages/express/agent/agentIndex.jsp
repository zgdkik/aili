...
<body>
	...
	<script type="text/javascript" src="<%=basePath%>scripts/express/agent/constants.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/express/agent/store.js"></script>
	<script type="text/javascript" src="<%=basePath%>scripts/express/agent/editForm.js"></script>	
	<script type="text/javascript" src="<%=basePath%>scripts/express/agent/listGrid.js"></script>
</body>
</html>