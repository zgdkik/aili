...
<html>
  ...
  <body>
    ...
    <script type="text/javascript" src="<%=basePath%>scripts/sysuser/SysUserForm.js"></script>
    <script type="text/javascript" src="<%=basePath%>scripts/sysuser/SysUserGrid.js"></script>
    <script type="text/javascript" src="<%=basePath%>scripts/sysuser/sysMain.js"></script>
  </body>
</html>
