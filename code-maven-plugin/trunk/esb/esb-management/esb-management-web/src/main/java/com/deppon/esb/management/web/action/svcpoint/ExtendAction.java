...
@Controller("extendAction")
@Scope("prototype")
public class ExtendAction extends ESBActionSupport{

	private static final long serialVersionUID = 1L;
	private static  Logger LOG = Logger.getLogger(ExtendAction.class); 
	@Resource
	...
	public String query(){
		try {
			...
			resultCount = svcpoint2Service.queryExtendCount(queryBean);
			//查询服务配置列表
			list = svcpoint2Service.queryExtendSvcpoint(queryBean);
			success=true;
		} catch (Exception e) {
