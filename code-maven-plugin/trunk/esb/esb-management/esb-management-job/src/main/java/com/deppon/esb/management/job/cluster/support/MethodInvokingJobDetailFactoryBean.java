 ...
 * 
 * @see ${symbol_dollar}{symbol_pound}afterPropertiesSet()
 */
public class MethodInvokingJobDetailFactoryBean implements FactoryBean, BeanNameAware, InitializingBean {
	private Log logger = LogFactory.getLog(MethodInvokingJobDetailFactoryBean.class);
	 ...
	 * 
	 * @see ${symbol_dollar}{symbol_pound}afterPropertiesSet()
	 * @see Scheduler${symbol_dollar}{symbol_pound}DEFAULT_GROUP
	 */
	 ...
	 * @see JobDetail${symbol_dollar}{symbol_pound}setName(String)
	 **/
	 ...
	 * 
	 * @see ${symbol_dollar}{symbol_pound}afterPropertiesSet()
	 * @see ${symbol_dollar}{symbol_pound}getObject()
	 * @see FactoryBean
	 **/
	 ...
	 * <p>
	 * {@link ${symbol_dollar} symbol_pound}targetClass} or targetObject must be set, but not
	 * both.
	 * <p>
	 * This object must be Serializable when {@link ${symbol_dollar} symbol_pound}concurrent}
	 * is set to false.
	 */
	 ...
	 * <p>
	 * targetMethod or {@link ${symbol_dollar} symbol_pound}staticMethod} should be set, but
	 * not both.
	 **/
	 ...
	 * targetClass or targetObject property, respectfully.
	 * <p>
	 * {@link ${symbol_dollar} symbol_pound}targetMethod} or staticMethod should be set, but
	 * not both.
	 */
	private String staticMethod;

	/**
	 * Method arguments provided to the {@link ${symbol_dollar} symbol_pound}targetMethod} or
	 * {@link ${symbol_dollar} symbol_pound}staticMethod} specified.
	 * <p>
	 * All arguments must be Serializable when {@link ${symbol_dollar}
	 * symbol_pound}concurrent} is set to false.
	 * <p>
	 ...
	 * 
	 * @see ${symbol_dollar}{symbol_pound}targetClass
	 * @return targetClass
	 */
	 ...
	 * 
	 * @see ${symbol_dollar}{symbol_pound}targetMethod
	 * @return targetMethod
	 */
	 ...
	 * @see ${symbol_dollar}{symbol_pound}jobDetail
	 * @see ${symbol_dollar}{symbol_pound}afterPropertiesSet()
	 * @see FactoryBean${symbol_dollar}{symbol_pound}getObject()
	 */
	 ...
	 * @see FactoryBean${symbol_dollar}{symbol_pound}getObjectType()
	 */
	...
	/**
	 * @return true
	 * @see FactoryBean${symbol_dollar}{symbol_pound}isSingleton()
	 */
	 ...
	 * 
	 * @see ${symbol_dollar}{symbol_pound}beanName
	 * @see BeanNameAware${symbol_dollar}{symbol_pound}setBeanName(String)
	 */
	 ...
	 * </ul>
	 * 
	 * @see org.springframework.beans.factory.InitializingBean${symbol_dollar}
	 *      {symbol_pound}afterPropertiesSet()
	 * @see JobDetail
	 * @see ${symbol_dollar}{symbol_pound}jobDetail
	 * @see ${symbol_dollar}{symbol_pound}beanName
	 * @see ${symbol_dollar}{symbol_pound}group
	 * @see MethodInvokingJob
	 * @see StatefulMethodInvokingJob
	 * @see ${symbol_dollar}{symbol_pound}durable
	 * @see ${symbol_dollar}{symbol_pound}volatility
	 * @see ${symbol_dollar}{symbol_pound}shouldRecover
	 * @see ${symbol_dollar}{symbol_pound}targetClass
	 * @see ${symbol_dollar}{symbol_pound}targetMethod
	 * @see ${symbol_dollar}{symbol_pound}jobListenerNames
	 */
	 ...
	 * 
	 * @param concurrent
	 * @see ${symbol_dollar}{symbol_pound}concurrent
	 */
	...
	/**
	 * setter for the {@link ${symbol_dollar} symbol_pound}jobListenerNames} property.
	 * 
	...
	/**
	 * setter for the {@link ${symbol_dollar} symbol_pound}shouldRecover} property.
	 * 
	 * @param shouldRecover
	 * @see ${symbol_dollar}{symbol_pound}shouldRecover
	 */
	...
	/**
	 * setter for the {@link ${symbol_dollar} symbol_pound}volatility} property.
	 * 
	 * @param volatility
	 * @see ${symbol_dollar}{symbol_pound}volatility
	 */
	 ...
	 * 
	 * @see MethodInvokingJobDetailFactoryBean${symbol_dollar}{symbol_pound}applicationContext
	 * @see ${symbol_dollar}{symbol_pound}execute(JobExecutionContext)
	 * 
	 * @author Stephen M. Wick
	 */
	public static class MethodInvokingJob implements Job {
		 ...
		 * 
		 * @see Job${symbol_dollar}{symbol_pound}execute(JobExecutionContext)
		 */
