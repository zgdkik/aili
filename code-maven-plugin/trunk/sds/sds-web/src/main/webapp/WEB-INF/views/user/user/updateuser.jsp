...
<body class="fixed-left" locale="zh-cn">
	...
	<div id="wrapper">
		...
		<div class="content-page">
			<ol class="breadcrumb">
				...
				<li><a href="${base}/user/userlist">用户管理</a></li>
											...
											<div class="form-group" id="roleids">
												...
												<div class="col-md-3">
													<label class="col-md-7 control-label">已有角色</label> <select
														id="keepRenderingSort_to" class="form-control" size="8"
														multiple="multiple">
											...
											<div class="form-group">
												<div class="col-md-9 col-md-offset-3">
													<button type="button" class="btn btn-primary"
														id="updateuser" value="Sign up">保存</button>
	...
	<script src="${base}/scripts/user/user-update.js?${version}"></script>
