...
import org.hbhk.hms.gateway.dubbo.DubboSubscribeChanges;
import org.hbhk.hms.gateway.dubbo.DubboSubscribeNodeChanges;
...
public class ServiceConfigLoader implements IServiceConfigLoader,
	...
	public String load(String url) {
		...
		String app = urls[1];
		String str = "http://" + LbRoundRobin.roundRobin(app) + url;
		return str;
	}
