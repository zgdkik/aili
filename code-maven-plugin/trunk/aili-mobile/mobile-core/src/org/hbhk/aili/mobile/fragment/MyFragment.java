...
import org.hbhk.aili.mobile.activity.BaseActivity;
import org.hbhk.aili.mobile.application.Constant;
import org.hbhk.aili.mobile.tabhost.FragmentInterface;
...
//		this.getActivity().finish();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && isSaveState()) {
            isOnInit = savedInstanceState.getBoolean(org.hbhk.aili.mobile.application.Constant.KEY_TAB_INIT);
        }
