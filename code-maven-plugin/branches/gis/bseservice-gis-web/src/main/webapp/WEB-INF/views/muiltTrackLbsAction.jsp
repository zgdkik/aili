...
var myGeo = new BMap.Geocoder();
	...
	var data ="<c:out value='${muiltTrackLbsJSONArray}'/>";//.replaceAll("&#034;", "\"");
	
	  while (data.indexOf("&#034;") >= 0){
		  data = data.replace("&#034;", "\"");
	    }
	  
	var muiltTrackLbsJSONArray = eval("("+data+")");
	var myIcon = new BMap.Icon("<%=path%>/images/track1.png",new BMap.Size(30, 38),{anchor: new BMap.Size(13, 35)});
      ...
      for(var i=0;i<muiltTrackLbsJSONArray.length;i++){
    	  var trackPoint = new BMap.Point(muiltTrackLbsJSONArray[i].point.split(",")[0],muiltTrackLbsJSONArray[i].point.split(",")[1]);
    		var marker = new BMap.Marker(trackPoint, {icon: myIcon});
    		 map.addOverlay(marker); 
    		 markerPoints.push(trackPoint);
    		 (function(){
						    		 			...
						    		 			myGeo.getLocation(pt, function(rs){
						    		 				var addComp = rs.addressComponents;
						    		 				  ...
						    		 				  var IsOnline_text = "";
						    		 				   ...
						    		 				   var txt ="<p class='turack_driver'><img  src="+imgSrc+" ></img></p><p class='text_css_style'>地址:"+address+" </br>时间："+trackInfo.time+" </br>司机名称: "+result_data.d.Data.Name+" </br>司机手机:<strong> "+result_data.d.Data.PhoneNumber+" </strong></br>车型: "+result_data.d.Data.TruckType+" </br>是否接活："+IsOnline_text+"</p>", mouseoverTxt = txt ;
						    		 					var opts = {
