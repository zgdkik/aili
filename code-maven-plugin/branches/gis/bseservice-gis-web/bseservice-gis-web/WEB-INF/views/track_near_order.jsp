...
var truckIcon = new BMap.Icon("<%=path%>/images/track1.png",new BMap.Size(30, 38),{anchor: new BMap.Size(13, 35)});
var vtruckIcon = new BMap.Icon("<%=path%>/images/vtruck.png",new BMap.Size(30, 38),{anchor: new BMap.Size(13, 35)});
//$.ajax拼接data的异步请求
//参数 省份 圆顶点 时间差 订单时间
var markerPoints=[];
		...
		var TrackOrdersAllDTOList = eval("("+json.TrackOrdersHistoricalDTOList+")");
	      for(var i=0;i<TrackOrdersAllDTOList.length;i++){
	    	  var trackPoint = new BMap.Point( TrackOrdersAllDTOList[i].latitude,TrackOrdersAllDTOList[i].longitude);
	    		var tIcon = null;
	    		if(TrackOrdersAllDTOList[i].isSignTruck=='1'){//V司机
	    			tIcon = vtruckIcon;
	    		}else{//普通司机
	    			tIcon = truckIcon;
	    		}
	    	  var marker = new BMap.Marker(trackPoint, {icon: tIcon});
