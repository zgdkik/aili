package org.hbhk.aili.core.server.arg;
...
import org.hbhk.aili.core.server.annotation.FormArray;
...
public class ArrayCommandMethodArgumentResolver implements
	...
	public boolean supportsParameter(MethodParameter parameter) {
		if (!parameter.hasParameterAnnotation(FormArray.class)) {
			return false;
		}
	...
	public Object resolveArgument(MethodParameter parameter,
		...
		FormArray c = (FormArray) parameter
				.getParameterAnnotation(FormArray.class);
