...
public final class FileLoadUtil {
	...
	public static Resource[] getResourcesForClasspath(
			String fileName) throws IOException {
		PathMatchingResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
	...
	public static Resource getResourceForClasspath(String fileName)
			throws IOException {
		return getResourcesForClasspath(fileName)[0];
	}
	...
	public static InputStream getInputStreamForClasspath(String fileName)
		...
		InputStream in = resource[0].getInputStream();
		return in;
	}
