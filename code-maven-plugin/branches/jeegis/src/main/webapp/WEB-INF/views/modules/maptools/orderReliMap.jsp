					...
					success : function(data) {
						...
						for (var i = 0; i < HeatOrders.length; i++) {
							...
							{ 
								...
								//orderBpoints.push(p);
								var relip = {"lng":HeatOrders[i].Location.Longitude,"lat":HeatOrders[i].Location.Latitude,"count":50};
		...
		<tr>
			<td style="width: 25%;height: 800px;    border-width: 0px;min-width: 200px;" >
				<div style="width: 100%;height: 100%;" id="right">
					<div id="" style="    width: 100%;height: 30px; background-color: #34A6E7; color: #fff; font-size: large; line-height: 30px;text-align: center;">红色麻点表示司机&nbsp;热力表示订单</div>
					<form:form id="searchForm" modelAttribute="orderLoadesTogetherMap"  class="breadcrumb form-search">
						<ul class="ul-form">
							...
							<li class="btns"><input id="showAgg1" class="btn btn-primary" type="button" onclick="showAgg();" value="订单热力"/></li>
