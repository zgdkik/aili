...
var Elevator = (function() {
	...
	function animateLoop(time) {
		...
		var easedPosition = easeInOutQuad(timeSoFar, startPosition,
	...
	function elevate() {
		...
		// No custom duration set, so we travel at pixels per millisecond.
		// (0.75px per ms)
		if (!customDuration) {
	...
	function main(options) {
		...
		if (options.mainAudio) {
			...
			mainAudio.setAttribute('preload', 'true'); // @TODO: Option to not
														// preload audio.
