...
<body style="width: 100%;" >
		...
		<div class="contenr-right">
			...
			<div class="contenr-right-bottom ub">
				...
				<div class="time1 ub" style="z-index:2"><!--href="javascript:history.back();  -->
					...
					<a style="float: right;cursor: pointer;z-index: 100;" id="life_next">&nbsp;&nbsp;下一篇&nbsp;&nbsp;</a>
					<a style="float: right;cursor: pointer;z-index:100;" id="life_prev">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上一篇&nbsp;&nbsp;</a>
	...
	<script type="text/javascript">
		//rowsId总条数
	 	...
	 	$("#life_prev").on('click',function(){
		$("#a_prev").on('click',function(){
	 		if(preId){
	 			location.href="${base}/ddwlGw/culturalLifeDetail?title=文化生活&noticeId="+preId+"&rowsId="+rowsId;
	 		}else{
	 			alert("没有更多数据");
	 		}
	 	...
	 	$("#life_next").on('click',function(){
	 		if(nextId){
	 			location.href="${base}/ddwlGw/culturalLifeDetail?title=文化生活&noticeId="+nextId+"&rowsId="+rowsId;
	 		}else{
	 			alert("没有更多数据");
	 		}
	 	});
	 	$("#returnList").on('click',function(){
	 		location.href="${base}/ddwlGw/notice?noticeType=4&compCode=ddwl";
	 	})      
	 		location.href="${base}/ddwlGw/culturalLife?noticeType=4&title=文化生活";
	 	})
		$(function(){
			...
			//rowsId总条数
		 	...
		 	for(var i=0;i<ids.length;i++){
		 	 ...
		 	 $("#life_prev").on('click',function(){
		 		if(preId){
		 			location.href="${base}/ddwlGw/culturalLifeDetail?noticeId="+preId+"&rowsId="+rowsId;
		 		}else{
		 			alert("没有更多数据");
		 		}
		 	 ...
		 	 $("#life_next").on('click',function(){
		 		if(nextId){
		 			location.href="${base}/ddwlGw/culturalLifeDetail?noticeId="+nextId+"&rowsId="+rowsId;
		 		}else{
		 			alert("没有更多数据");
		 		}
		 	});  
		 	 $.ajax({
		        ...
		        success: function(data){
		        	//总页数
		        	$(".news-content").html(data.data.noticeContent);
