	...
	<!-- 		<li><a href="#"
				...
				<div class="dropdown-menu dropdown-menu-head pull-right">
					...
					<ul class="dropdown-list normal-list">
						<li class="new"><a href=""> <span class="thumb"><img
									src="${base}/images/home/icon/logo_icon.png" alt="" /></span> <span class="desc">
									<span class="name">${userContext.name}<span
		...
		<!-- 	<li><a href="#"
			...
			<a href="#" class="btn btn-default dropdown-toggle"
				data-toggle="dropdown"> <img src="${base}/images/home/icon/user1.png"
					alt="" />${userContext.userName}<span class="caret"></span>
			</a>
				<ul class="dropdown-menu dropdown-menu-usermenu pull-right">
					<li><a href="#"><i class="fa fa-cog"></i>设置</a></li>
					<li><a href="#" class="logout"><i class="fa fa-sign-out"></i>退出</a></li>
				</ul></li>
