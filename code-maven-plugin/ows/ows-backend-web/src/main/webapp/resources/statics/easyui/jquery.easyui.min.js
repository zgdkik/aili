		...
		function _224() {
			if (opts.noheader || (!opts.title && !opts.header)) {
				...
				if (opts.header) {
					...
					if (!_228.length) {
						_228 = $('<div class="panel-header"></div>').prependTo(
								_223)
					}
		...
		if (opts.buttons) {
			if ($.isArray(opts.buttons)) {
				...
				for (var i = 0; i < opts.buttons.length; i++) {
					...
					var _299 = $('<a href="javascript:void(0)"></a>').appendTo(
							_298);
					if (p.handler) {
...
(function($) {
	...
	function _41f(_420, _421) {
		...
		if (_421.iconCls) {
			$('<div class="menu-icon"></div>').addClass(_421.iconCls).appendTo(
					item)
		}
		if (_421.id) {
...
(function($) {
	...
	function _526(_528, _529) {
		...
		function _52c(_52d) {
			...
			try {
				for ( var n in _52d) {
					var _52f = $('<input type="hidden" name="' + n + '">').val(
							_52d[n]).appendTo(form);
					_52e = _52e.add(_52f)
				}
				_530();
				form[0].submit()
			...
			function _698(type) {
				...
				if (type == "header") {
					...
					opts.finder.getTr(_690, 0, type).find(
							'td[field="' + _695 + '"] div.datagrid-cell').each(
							function() {
								var w = _69a($(this));
								if (_699 < w) {
									_699 = w
	...
	var _7b7 = {
		...
		renderTable : function(_7c0, _7c1, rows, _7c2) {
			...
			for (var i = 0; i < rows.length; i++) {
				...
				_7c5.push('<tr id="' + _7c7 + '" datagrid-row-index="' + _7c1
						+ '" ' + cls + " " + _7c6 + ">");
		...
		insertRow : function(_7e3, _7e4, row) {
			...
			function _7ea(_7eb) {
				...
				var tr = '<tr id="' + _7ee
						+ '" class="datagrid-row" datagrid-row-index="' + _7e4
						+ '"></tr>';
				if (_7e4 >= data.rows.length) {
					if (data.rows.length) {
						...
						renderFooter : function(_938, _939, _93a) {
							...
							for (var i = 0; i < rows.length; i++) {
								...
								row[opts.idField] = row[opts.idField]
										|| ("foot-row-id" + i);
								_93c.push('<tr class="datagrid-row" node-id="'
										+ row[opts.idField] + '">');
...
(function($) {
	function _a95(_a96) {
		...
		if (!_a97.calendar) {
			...
			var cc = $('<div class="datebox-calendar-inner"></div>').prependTo(
					_a9b);
