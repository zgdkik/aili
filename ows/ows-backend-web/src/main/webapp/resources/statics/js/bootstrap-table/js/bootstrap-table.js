...
//        dataType: 'json',
        ...
        onDblClickRow: function (item, $tr) {
//        	var expand = true;
...
//             }
    ...
    BootstrapTable.LOCALES['en-US'] = BootstrapTable.LOCALES['en'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('显示 %s 到  %s 总条数:%s', pageFrom, pageTo, totalRows);
        },
        formatDetailPagination: function (totalRows) {
            return sprintf('显示 %s 条数', totalRows);
        },
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        if(this.options.pagination) {
          ...
          //  params.pageNumber = this.options.pageNumber;
            params['page.pageSize']= this.options.pageSize === this.options.formatAllRows() ?
                this.options.totalRows : this.options.pageSize;
            params['page.pageNum']= this.options.pageNumber;
        }
    ...
    BootstrapTable.prototype.resetView = function (params) {
        ...
        // Assign the correct sortable arrow
        this.getCaret();
        this.$tableContainer.css('padding-bottom', 20 + 'px');
